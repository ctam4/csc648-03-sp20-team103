...
test("/recipes/search | GET | 400", async (t) => {
  await fetch(
    t.context.baseUrl +
      "/v4/recipes/search?session=abcd&query=blah&page=1&limit=50",
    {
      method: "get",
      headers: {
        Accept: "application/json",
...
test("/recipes/search | GET | 401", async (t) => {
  await fetch(
    t.context.baseUrl +
      "/v4/recipes/search?session=123456789012345678901234567890123456&query=blah&page=1&limit=50",
    {
      method: "get",
      headers: {
        Accept: "application/json",
...
test("/recipes | GET | 400", async (t) => {
  await fetch(
    t.context.baseUrl + "/v4/recipes?session=abcd&recipeIDs=12345678",
    {
      method: "get",
      headers: {
        Accept: "application/json",
...
test("/recipes | GET | 401", async (t) => {
  await fetch(
    t.context.baseUrl +
      "/v4/recipes?session=123456789012345678901234567890123456&recipeIDs=1",
    {
      method: "get",
      headers: {
        Accept: "application/json",
