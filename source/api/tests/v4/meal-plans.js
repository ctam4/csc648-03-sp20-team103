...
test("/meal-plans | GET | 400", async (t) => {
  await fetch(
    t.context.baseUrl +
      "/v4/meal-plans?session=abcd&userID=1&plannedDate=1589673600",
    {
      method: "get",
      headers: {
        Accept: "application/json",
...
test("/meal-plans | GET | 401", async (t) => {
  await fetch(
    t.context.baseUrl +
      "/v4/meal-plans?session=123456789012345678901234567890123456&userID=" +
      t.context.userID +
      "&plannedDate=1589673600000",
    {
      method: "get",
      headers: {
        Accept: "application/json",
